...
import { ArrowRight, FileText, Github, Globe, LayoutDashboard, Rocket } from "lucide-react";
  ...
  return (
    <div className="grid min-h-screen grid-rows-[20px_1fr_20px] items-center justify-items-center gap-16 p-8 pb-20 font-[family-name:var(--font-geist-sans)] sm:p-20">
      <main className="row-start-2 flex flex-col items-center gap-[32px] sm:items-start">
        ...
        <a
          className="flex items-center gap-2 rounded-md bg-black px-4 py-2 text-white transition-colors hover:bg-gray-800"
      ...
      <footer className="row-start-3 flex flex-wrap items-center justify-center gap-[24px]">
        ...
        >
          <Globe size={16} />
          Go to nextjs.org <ArrowRight size={14} />
        </a>
      </footer>
    </div>
  );
